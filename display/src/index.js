   ...
   useEffect(() => {
    ...
    ipcRenderer.on("server-data", (event, data) => {
      ...
      if (data.Mode === 9) {
        ...
        else if (data.Mode === 21 || data.medias?.Mode === 21) {
    ...
    <>
      {test === "test" ? (
        ...
        <>
          ...
          {switchToScore && mode === "prematch" && <ScoringMode gameState={gameState}/>}
          {switchToScore === false && mode === "prematch" && <PrematchMode mediaState={mediaState} mediaMode={mediaMode} gameState={gameState} setSwitchToScore={setSwitchToScore}/> }
          {mode === "logo" && <LogoMode />}
          {mode === "sleep" && <></>}
