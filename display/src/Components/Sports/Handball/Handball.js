  ...
  return (
    <div className="container">
      <div className="absolute-div home-div">
        ...
        <div className="time-div" style={{ left: '0px', top: '211px' }}>{formatExclusionTimer(gameState?.Home?.Exclusion?.Timer[2]) || ""}</div>
        <div className="shirt-div" style={{ left: '50px', top: '211px' }}>{gameState?.Home?.Exclusion?.ShirtNumber[2] || ""}</div>


        <div className="time-div" style={{ left: '0px', top: '175px' }}>{formatExclusionTimer(gameState?.Home?.Exclusion?.Timer[1]) || ""}</div>
        <div className="shirt-div" style={{ left: '50px', top: '175px' }}>{gameState?.Home?.Exclusion?.ShirtNumber[1] || ""}</div>

        <div className="time-div" style={{ left: '0px', top: '139px' }}>{formatExclusionTimer(gameState?.Home?.Exclusion?.Timer[0]) || ""}</div>
        <div className="shirt-div" style={{ left: '50px', top: '139px' }}>{gameState?.Home?.Exclusion?.ShirtNumber[0] || ""}</div>
      ...
      <div className="absolute-div guest-div">
        ...
        <div className="shirt-div" style={{ left: '69px', top: '211px' }}>{gameState?.Guest?.Exclusion?.ShirtNumber[2] || ""}</div>

        <div className="time-div" style={{ left: '118px', top: '175px' }}>{formatExclusionTimer(gameState?.Guest?.Exclusion.Timer[1]) || ""}</div>
        <div className="shirt-div" style={{ left: '69px', top: '175px' }}>{gameState?.Guest?.Exclusion?.ShirtNumber[1] || ""}</div>

        <div className="time-div" style={{ left: '118px', top: '139px' }}>{formatExclusionTimer(gameState?.Guest?.Exclusion.Timer[0]) || ""}</div>
        <div className="shirt-div" style={{ left: '69px', top: '139px' }}>{gameState?.Guest?.Exclusion?.ShirtNumber[0] || ""}</div>
